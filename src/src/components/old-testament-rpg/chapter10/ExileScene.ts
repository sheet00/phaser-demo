...
export default class ExileScene extends ChronicleScene {
  ...
  private prayByRiver() {
    ...
    this.time.delayedCall(1700, () => this.talk([
      ...
      { speaker: 'バビロニア帝国の滅亡①', body: '捕囚から約70年後、バビロンの王が神殿から奪った金の杯で\n大宴会を開いた夜——突然、壁に謎の文字が現れた。\n「あなたの王国は終わった」。神の裁きだった。' },
      { speaker: 'バビロニア帝国の滅亡②', body: 'その夜、ペルシアのキュロス大王の軍がユーフラテス川をせき止め、\n川底から城壁内へ侵入。70年間君臨した大帝国バビロニアは\n一夜にして崩壊した。' },
